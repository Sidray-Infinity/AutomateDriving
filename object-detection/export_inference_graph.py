...
Example Usage:
--------------
python export_inference_graph.py --input_type image_tensor --pipeline_config_path training/ssd_mobilenet_v1_coco_2018_01_28.config --trained_checkpoint_prefix TrainedModels/model-28220/model.ckpt-28220 --output_directory TrainedModels/model-28220/inference-graph
